...
if (\PHP_VERSION_ID < 80400) {
     ...
     */
    final class WooCustomGateway_ReflectionConstant
    {
        /**
         * @var string
         *
        ...
        {
            throw new Exception("Serialization of 'WooCustomGateway_ReflectionConstant' is not allowed");
        }

        public function __wakeup(): void
        {
            throw new Exception("Unserialization of 'WooCustomGateway_ReflectionConstant' is not allowed");
        }
    }
}
